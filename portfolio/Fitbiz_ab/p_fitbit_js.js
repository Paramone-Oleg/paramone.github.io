...
return Swipe;}));function func2(){document.getElementById('adver-inner').classList.add('pr');}
setTimeout(func2,1400);function func3(){document.getElementById('adver-inner').classList.remove('loadingad');document.getElementById('adver-inner').classList.remove('pr');}
setTimeout(func3,2700);var element=document.getElementById('mySwipe'),prevBtn=document.getElementById('p_prev'),nextBtn=document.getElementById('p_next');window.mySwipe=new Swipe(element,{startSlide:0,auto:3000,draggable:true,autoRestart:false,continuous:true,disableScroll:true,stopPropagation:true,callback:function(index,element){},transitionEnd:function(index,element){}});prevBtn.onclick=mySwipe.prev;nextBtn.onclick=mySwipe.next;function rudrSwitchTab1(rudr_tab_id1,rudr_tab_content1){var x=document.getElementsByClassName("tabcontent ");var i;for(i=0;i<x.length;i++){x[i].style.display='none';}
document.getElementById(rudr_tab_content1).style.display='block';var x=document.getElementsByClassName("tabmenu 1");var i;for(i=0;i<x.length;i++){x[i].className='tabmenu 1';}
document.getElementById(rudr_tab_id1).className='tabmenu 1 active';}
function rudrSwitchTab2(rudr_tab_id2,rudr_tab_content2){var x=document.getElementsByClassName("tabcontent 2");var i;for(i=0;i<x.length;i++){x[i].style.display='none';}
document.getElementById(rudr_tab_content2).style.display='block';var x=document.getElementsByClassName("tabmenu 2");var i;for(i=0;i<x.length;i++){x[i].className='tabmenu 2';}
document.getElementById(rudr_tab_id2).className='tabmenu 2 active';}
function rudrSwitchTab3(rudr_tab_id3,rudr_tab_content3){var x=document.getElementsByClassName("tabcontent 3");var i;for(i=0;i<x.length;i++){x[i].style.display='none';}
document.getElementById(rudr_tab_content3).style.display='block';var x=document.getElementsByClassName("tabmenu 3");var i;for(i=0;i<x.length;i++){x[i].className='tabmenu 3';}
document.getElementById(rudr_tab_id3).className='tabmenu 3 active';}
document.getElementById('adver-inner').classList.add('anyload');